...
module.exports = {
  getRecommendMusic: getRecommendMusic,//推荐页数据
  getTopMusic: getTopMusic,//排行榜数据
  getHotSearchKey: getHotSearchKey,//关键字
  getSearchMusic: getSearchMusic,//搜索音乐结果
  getTopListInfo: getTopListInfo,//跳转的排行列表
  getAlbumInfo: getAlbumInfo,//获取专辑数据
